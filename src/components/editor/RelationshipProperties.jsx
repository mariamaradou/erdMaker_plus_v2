...
class RelationshipProperties extends React.Component {
  ...
  render() {
    ...
    var addConnectionButton =
     ...
     (this.props.components.relationships[relationshipIndex].connections.length>1 && (this.props.components.notation==="Crow's foot Notation" || this.props.components.notation==="Bachman Notation" ))? null:
