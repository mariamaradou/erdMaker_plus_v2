...
export const stageReducer = (state = stageInitialState, action) => {
  switch (action.type) {
    case "UPDATE_SIDEPANEL_WIDTH":
      ...
      //neo
      case "UPDATE_SIDEPANEL_HEIGHT":
      var sidepanelHeight;
      if (window.innerHeight <= 527) sidepanelHeight = { standard: 100, wide: 100 };
      else if (window.innerHeight <= 1060) sidepanelHeight= { standard: 40, wide: 50 };
      else sidepanelHeight = { standard: 25, wide: 30 };
      return {
        ...state,
